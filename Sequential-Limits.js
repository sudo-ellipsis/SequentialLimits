...
var init = () => {
    ...
    // a1
    {
        ...
        a1 = theory.createUpgrade(0, currency, new FirstFreeCost(new ExponentialCost(1, 0.362*Math.log2(10)))); //0'th upgrade in the list - first cost is 0, other costs are 10 * 2^(3*level), costs currency1
    ...
    // b1
    {
        ...
        b1 = theory.createUpgrade(2, currency, new ExponentialCost(2500, 0.655*Math.log2(10))); //2nd upgrade in the list - costs are 100 + 10^level, costs currency1
    ...
    // b2
    {
        ...
        b2 = theory.createUpgrade(3, currency, new ExponentialCost(7500, 0.926*Math.log2(10))); //3rd upgrade in the list - costs are 3*10^(3*level), costs currency1
